-- Insert default INTERPRETATION prompt entry
INSERT INTO "aiprompt" ("key", "defs", "role", "createdAt", "updatedAt")
VALUES (
  'INTERPRETATION',
  $prompt$You are analyzing replies from Instagram users invited to a specific event.
...
{messages}$prompt$,
  $role$You are a human intent interpreter for event invitations.
