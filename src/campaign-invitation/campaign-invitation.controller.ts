...
export class CampaignInvitationController {
  ...
  @Patch('mark-no-show')
  @ApiOperation({
    summary: 'Mark invitations as no-show',
    description: 'Updates the status of specified invitations to "no-show".',
  })
  @ApiResponse({
    status: 200,
    description: 'Invitations successfully marked as no-show',
    schema: {
      type: 'object',
      properties: {
        count: {
